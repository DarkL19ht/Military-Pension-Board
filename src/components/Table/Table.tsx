                    ...
                    <table className="w-full text-left text-sm font-light">
                        ...
                        <tbody>
                            <tr className="border-b">
                                <td className="whitespace-nowrap px-4 py-2 text-center text-[10px] font-medium">
                                    01
                                </td>
                                ...
                                <td className="t whitespace-nowrap px-4 py-2 text-center text-[10px]">
                                    Andrew
                                </td>
                                <td className="whitespace-nowrap px-4 py-2  text-center text-[10px]">
                                    Garba
                            ...
                            <tr className="border-b">
                                ...
                                <td className="whitespace-nowrap px-4 py-2  text-center text-[10px]">
                                    <span className="rounded-[16px] bg-[#FFE5E5] px-[12px] py-[4px] font-[600] text-[#DC2C2C]">
                                        Failed
                                    </span>
                                </td>
                                <td className="cursor-pointer whitespace-nowrap px-4 py-2  text-center text-[10px]">
                            ...
                            <tr className="border-b">
                                ...
                                <td className="whitespace-nowrap px-4 py-2  text-center text-[10px]">
                                    <span className="rounded-[16px] bg-[#FEF4DB] px-[12px] py-[4px] font-[600] text-[#EFB008]">
                                        Pending
                                    </span>
                                </td>
                                <td className="cursor-pointer whitespace-nowrap px-4 py-2  text-center text-[10px]">
